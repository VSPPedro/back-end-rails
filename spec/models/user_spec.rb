...
RSpec.describe User, type: :model do
  ...
  describe '#generate_authentication_token!' do
    ...
    it 'generates anothe auth token when the current auth token already has been taken' do
      allow(Devise).to receive(:friendly_token).and_return('abc321xyzTOKEN', 'abc321xyzTOKEN', 'abcXYZ123TOKEN')
